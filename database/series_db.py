...
class Database:
    ...
    async def set_update_content_snapshot(self, series_id, snapshot: str):
        """Set the content snapshot hash used to detect duplicate update messages"""
        await self.series.update_one(
            {'_id': series_id},
            {'$set': {'update_content_snapshot': snapshot}}
        )
