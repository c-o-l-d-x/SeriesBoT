...
from .recent_list import update_recent_list, remove_from_recent_list  # For recent list channel
import logging
import uuid
import io
import asyncio
...
/recent {channel_id} - Send recently added series list to a channel
...
/status - View bot statistics (series, users, chats, storage)
...
async def delete_series_command(client: Client, message: Message):
    ...
    try:
        ...
        # Delete the series
        series_id_to_delete = found_series['_id']
        await remove_from_recent_list(client, series_id_to_delete)
        await db.delete_series(series_id_to_delete)
...
async def callback_handler(client: Client, callback_query: CallbackQuery):
    ...
    try:
        ...
        # Confirm delete series
            ...
            await remove_from_recent_list(client, series_id)
        ...
        # Confirm delete season
            ...
            # Refresh recent list entry for this series (season removed, show new latest)
            await update_recent_list(client, series_id)
        ...
        # Confirm delete episode
            ...
            # Refresh recent list entry for this series (episode removed)
            await update_recent_list(client, series_id)
